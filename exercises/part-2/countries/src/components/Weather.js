    ...
    if (currentWeather) {
        return (
            <div>
                ...
                <img src={`https:${currentWeather["current"].condition.icon}`} alt={`Weather ${capital}`}/>
                <p>Wind: {currentWeather["current"].wind_kph} km/h  / Direction: {currentWeather["current"].wind_dir}</p>
            </div>
        )
    }*/
